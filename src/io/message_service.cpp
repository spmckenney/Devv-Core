...
void
TransactionServer::SendMessage(std::unique_ptr<DevcashMessage> dc_message) noexcept {
...
void
TransactionServer::QueueMessage(std::unique_ptr<DevcashMessage> message) noexcept
{
...
TransactionClient::ProcessIncomingMessage() noexcept {
  ...
  auto devcash_message = std::unique_ptr<DevcashMessage>(
